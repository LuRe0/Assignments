...
void test4(void)
{
  ...
  unfuse( combined );
  if ( 
  compare_files( "test5_student_out1", "test5_expected_1" ) +
  compare_files( "test5_student_out2", "test5_expected_2" ) == 0 ) {
    printf( "+++Looks good\n" );
  }
}
...
void test5(void)
{
    char const* combined = "test5_student_output4";
    char const* expected_combined = "test5_input";
    char const* pp[] = { "test5-expected-4.jpg"};
    fuse(pp, sizeof(pp) / sizeof(*pp), combined);
    if (compare_files(combined, expected_combined) == 0) {
        printf("+++Looks good\n");
    }
...
void test6(void)
{
    char const* combined = "test5_student_output4"; /* contains 5 (larger) files test4_student_out1 etc */
    unfuse(combined);
    if (
        compare_files("test5_student_out4.jpg", "test5-expected-4.jpg") == 0) {
        printf("+++Looks good\n");
    }
}
