...
void ProjectOne::setup()
{
    ...
    auto overseer = agents->create_behavior_agent("Overseer", BehaviorTreeTypes::BT_Overseer);
    //agents->create_behavior_agent("ExampleAgent", BehaviorTreeTypes::Example);
    overseer->set_position(Vec3(terrain->mapSizeInWorld, 0, terrain->mapSizeInWorld * 0.5f));
